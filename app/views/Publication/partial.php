<div class='jumbotron' id='publication<?=$data->publication_id?>' style='text-align: center;'>
	<hr>
	<?php $profile=$data->getProfile(); ?>
	<a href="/Publication/details/<?=$data->publication_id?>"><img src="/images/<?= $data->picture ?>" width='600px'></a>
